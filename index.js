...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const arr = zooAnimals.map(element => element["animal_name"].toLowerCase());
    return arr;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const arr = zooAnimals.filter(element => element.population < 5);
    return arr;
  }
  ...
  */
  ...
  function USApop(zooAnimal){
      const arr = zooAnimal.reduce((acc, cur) => acc + cur.population, 0);
      return arr;
  }
...
const cuboidTwo = new CuboidMakerTwo(1,2,3);
